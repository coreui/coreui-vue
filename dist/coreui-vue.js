(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-clickaway'), require('vue-perfect-scrollbar'), require('vue-chartjs'), require('@coreui/coreui-plugin-chartjs-custom-tooltips')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue-clickaway', 'vue-perfect-scrollbar', 'vue-chartjs', '@coreui/coreui-plugin-chartjs-custom-tooltips'], factory) :
  (factory((global['coreui-vue'] = {}),global.vueClickaway,global.vuePerfectScrollbar,null,null));
}(this, (function (exports,vueClickaway,VuePerfectScrollbar,vueChartjs,coreuiPluginChartjsCustomTooltips) { 'use strict';
