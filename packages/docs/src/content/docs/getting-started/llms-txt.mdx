...
title: "LLMs.txt"
name: "LLMs.txt"
description: "LLM-optimized documentation endpoints for CoreUI for Vue — llms.txt, llms-full.txt, and a Markdown version of every page."
---
...
For a richer, tool-based integration, see [AI Tools (MCP)](/vue/docs/getting-started/ai-tools/).
...
For example: [/vue/docs/components/accordion.md](/vue/docs/components/accordion.md)
