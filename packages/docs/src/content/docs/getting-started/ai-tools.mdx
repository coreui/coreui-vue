...
title: "AI Tools (MCP)"
name: "AI Tools (MCP)"
description: "Bring the CoreUI for Vue documentation into your AI coding assistant with the @coreui/docs-mcp Model Context Protocol server."
---
...
```bash
claude mcp add coreui-docs -- npx -y @coreui/docs-mcp --framework vue
```
