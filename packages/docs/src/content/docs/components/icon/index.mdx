...
<Example code={IconSingleIconExampleRaw} name="IconSingleIconExample">
...
<Example code={IconUtilityClassesExampleRaw} name="IconUtilityClassesExample">
...
<Example code={IconCSSVariablesExampleRaw} name="IconCSSVariablesExample">
...
<Example code={IconCustomSVGIconsExampleRaw} name="IconCustomSVGIconsExample">
