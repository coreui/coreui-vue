...
<Example code={SidebarExampleRaw} name="SidebarExample">
...
<Example code={SidebarNarrowExampleRaw} name="SidebarNarrowExample">
...
<Example code={SidebarUnfoldableExampleRaw} name="SidebarUnfoldableExample">
...
<Example code={SidebarCompactExampleRaw} name="SidebarCompactExample">
...
<Example code={SidebarTreeExampleRaw} name="SidebarTreeExample">
...
<Example code={SidebarGroupIndicatorExampleRaw} name="SidebarGroupIndicatorExample">
...
<Example code={SidebarCustomIndicatorExampleRaw} name="SidebarCustomIndicatorExample">
...
<Example code={SidebarControlledGroupExampleRaw} name="SidebarControlledGroupExample">
...
<Example code={SidebarDarkExampleRaw} name="SidebarDarkExample">
