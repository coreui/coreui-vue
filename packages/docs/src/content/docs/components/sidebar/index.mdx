...
<Example code={SidebarExampleRaw} lang="vue" name="SidebarExample">
...
<Example code={SidebarNarrowExampleRaw} lang="vue" name="SidebarNarrowExample">
...
<Example code={SidebarUnfoldableExampleRaw} lang="vue" name="SidebarUnfoldableExample">
...
<Example code={SidebarCompactExampleRaw} lang="vue" name="SidebarCompactExample">
...
<Example code={SidebarTreeExampleRaw} lang="vue" name="SidebarTreeExample">
...
<Example code={SidebarGroupIndicatorExampleRaw} lang="vue" name="SidebarGroupIndicatorExample">
...
<Example code={SidebarCustomIndicatorExampleRaw} lang="vue" name="SidebarCustomIndicatorExample">
...
<Example code={SidebarControlledGroupExampleRaw} lang="vue" name="SidebarControlledGroupExample">
...
<Example code={SidebarDarkExampleRaw} lang="vue" name="SidebarDarkExample">
