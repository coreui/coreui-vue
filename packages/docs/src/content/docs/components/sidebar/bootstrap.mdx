...
<Example class="theme-bootstrap" code={SidebarExampleRaw} lang="vue" name="SidebarExample">
...
<Example class="theme-bootstrap" code={SidebarNarrowExampleRaw} lang="vue" name="SidebarNarrowExample">
...
<Example class="theme-bootstrap" code={SidebarUnfoldableExampleRaw} lang="vue" name="SidebarUnfoldableExample">
...
<Example class="theme-bootstrap" code={SidebarCompactExampleRaw} lang="vue" name="SidebarCompactExample">
...
<Example class="theme-bootstrap" code={SidebarTreeExampleRaw} lang="vue" name="SidebarTreeExample">
...
<Example class="theme-bootstrap" code={SidebarGroupIndicatorExampleRaw} lang="vue" name="SidebarGroupIndicatorExample">
...
<Example class="theme-bootstrap" code={SidebarCustomIndicatorExampleRaw} lang="vue" name="SidebarCustomIndicatorExample">
...
<Example class="theme-bootstrap" code={SidebarControlledGroupExampleRaw} lang="vue" name="SidebarControlledGroupExample">
...
<Example class="theme-bootstrap" code={SidebarDarkExampleRaw} lang="vue" name="SidebarDarkExample">
