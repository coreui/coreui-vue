...
<Example code={ChartLineExampleRaw} name="ChartLineExample">
...
<Example code={ChartBarExampleRaw} name="ChartBarExample">
...
<Example code={ChartRadarExampleRaw} name="ChartRadarExample">
...
<Example code={ChartDoughnutAndPieExampleRaw} name="ChartDoughnutAndPieExample">
  <ChartDoughnutAndPieExample client:only="vue" />
</Example>

<Example code={ChartDoughnutAndPieChartsExampleRaw} name="ChartDoughnutAndPieChartsExample">
...
<Example code={ChartPolarAreaExampleRaw} name="ChartPolarAreaExample">
...
<Example code={ChartBubbleExampleRaw} name="ChartBubbleExample">
...
<Example code={ChartScatterExampleRaw} name="ChartScatterExample">
