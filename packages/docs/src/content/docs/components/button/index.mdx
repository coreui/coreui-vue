...
<Example code={ButtonExampleRaw} lang="vue" name="ButtonExample">
...
<Example code={ButtonComponentsExampleRaw} lang="vue" name="ButtonComponentsExample">
...
<Example code={ButtonOutlineBaseClassExampleRaw} lang="vue" name="ButtonOutlineBaseClassExample">
...
<Example code={ButtonOutlineExampleRaw} lang="vue" name="ButtonOutlineExample">
...
<Example code={ButtonGhostBaseClassExampleRaw} lang="vue" name="ButtonGhostBaseClassExample">
...
<Example code={ButtonGhostExampleRaw} lang="vue" name="ButtonGhostExample">
...
<Example code={ButtonSizesExampleRaw} lang="vue" name="ButtonSizesExample">
...
<Example code={ButtonShapePillExampleRaw} lang="vue" name="ButtonShapePillExample">
  <ButtonShapePillExample client:only="vue" />
</Example>

### Square buttons

<Example code={ButtonShapeSquareExampleRaw} lang="vue" name="ButtonShapeSquareExample">
...
<Example code={ButtonDisabledExampleRaw} lang="vue" name="ButtonDisabledExample">
...
<Example code={ButtonDisabled2ExampleRaw} lang="vue" name="ButtonDisabled2Example">
...
<Example code={ButtonBlockExampleRaw} lang="vue" name="ButtonBlockExample">
  <ButtonBlockExample client:only="vue" />
</Example>

Here we create a responsive variation, starting with vertically stacked buttons until the `md` breakpoint, where `.d-md-block` replaces the `.d-grid` class, thus nullifying the `gap-2` utility. Resize your browser to see them change.

<Example code={ButtonBlock2ExampleRaw} lang="vue" name="ButtonBlock2Example">
  <ButtonBlock2Example client:only="vue" />
</Example>

You can adjust the width of your block buttons with grid column width classes. For example, for a half-width "block button", use `.col-6`. Center it horizontally with `.mx-auto`, too.

<Example code={ButtonBlock3ExampleRaw} lang="vue" name="ButtonBlock3Example">
  <ButtonBlock3Example client:only="vue" />
</Example>

Additional utilities can be used to adjust the alignment of buttons when horizontal. Here we've taken our previous responsive example and added some flex utilities and a margin utility on the button to right align the buttons when they're no longer stacked.

<Example code={ButtonBlock4ExampleRaw} lang="vue" name="ButtonBlock4Example">
