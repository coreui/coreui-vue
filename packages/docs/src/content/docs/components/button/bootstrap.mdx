...
<Example class="theme-bootstrap" code={ButtonExampleRaw} name="ButtonExample">
...
<Example class="theme-bootstrap" code={ButtonComponentsExampleRaw} name="ButtonComponentsExample">
...
<Example class="theme-bootstrap" code={ButtonOutlineBaseClassExampleRaw} name="ButtonOutlineBaseClassExample">
...
<Example class="theme-bootstrap" code={ButtonOutlineExampleRaw} name="ButtonOutlineExample">
...
<Example class="theme-bootstrap" code={ButtonGhostBaseClassExampleRaw} name="ButtonGhostBaseClassExample">
...
<Example class="theme-bootstrap" code={ButtonGhostExampleRaw} name="ButtonGhostExample">
...
<Example class="theme-bootstrap" code={ButtonSizesExampleRaw} name="ButtonSizesExample">
...
<Example class="theme-bootstrap" code={ButtonShapePillExampleRaw} name="ButtonShapePillExample">
  <ButtonShapePillExample client:only="vue" />
</Example>

### Square buttons

<Example class="theme-bootstrap" code={ButtonShapeSquareExampleRaw} name="ButtonShapeSquareExample">
...
<Example class="theme-bootstrap" code={ButtonDisabledExampleRaw} name="ButtonDisabledExample">
...
<Example class="theme-bootstrap" code={ButtonDisabled2ExampleRaw} name="ButtonDisabled2Example">
...
<Example class="theme-bootstrap" code={ButtonBlockExampleRaw} name="ButtonBlockExample">
  <ButtonBlockExample client:only="vue" />
</Example>

Here we create a responsive variation, starting with vertically stacked buttons until the `md` breakpoint, where `.d-md-block` replaces the `.d-grid` class, thus nullifying the `gap-2` utility. Resize your browser to see them change.

<Example class="theme-bootstrap" code={ButtonBlock2ExampleRaw} name="ButtonBlock2Example">
  <ButtonBlock2Example client:only="vue" />
</Example>

You can adjust the width of your block buttons with grid column width classes. For example, for a half-width "block button", use `.col-6`. Center it horizontally with `.mx-auto`, too.

<Example class="theme-bootstrap" code={ButtonBlock3ExampleRaw} name="ButtonBlock3Example">
  <ButtonBlock3Example client:only="vue" />
</Example>

Additional utilities can be used to adjust the alignment of buttons when horizontal. Here we've taken our previous responsive example and added some flex utilities and a margin utility on the button to right align the buttons when they're no longer stacked.

<Example class="theme-bootstrap" code={ButtonBlock4ExampleRaw} name="ButtonBlock4Example">
