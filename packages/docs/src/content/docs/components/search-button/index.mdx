...
<Example code={SearchButtonExampleRaw} lang="vue" name="SearchButtonExample">
...
<Example code={SearchButtonCustomShortcutExampleRaw} lang="vue" name="SearchButtonCustomShortcutExample">
...
<Example code={SearchButtonOffcanvasExampleRaw} lang="vue" name="SearchButtonOffcanvasExample">
