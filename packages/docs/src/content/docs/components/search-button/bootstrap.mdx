---
title: "Vue Bootstrap Search Button Component"
name: "Search Button with Bootstrap Styling"
bootstrap: true
description: "Learn how to use CoreUI’s Vue Search Button component with Bootstrap styles for flexible, framework-consistent UI."
---
...
<Example class="theme-bootstrap" code={SearchButtonExampleRaw} lang="vue" name="SearchButtonExample">
...
<Example class="theme-bootstrap" code={SearchButtonCustomShortcutExampleRaw} lang="vue" name="SearchButtonCustomShortcutExample">
...
<Example class="theme-bootstrap" code={SearchButtonOffcanvasExampleRaw} lang="vue" name="SearchButtonOffcanvasExample">
