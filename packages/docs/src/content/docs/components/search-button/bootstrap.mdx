...
<Example class="theme-bootstrap" code={SearchButtonExampleRaw} name="SearchButtonExample">
...
<Example class="theme-bootstrap" code={SearchButtonCustomShortcutExampleRaw} name="SearchButtonCustomShortcutExample">
...
<Example class="theme-bootstrap" code={SearchButtonOffcanvasExampleRaw} name="SearchButtonOffcanvasExample">
