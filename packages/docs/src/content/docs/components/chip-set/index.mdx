...
The CoreUI **Vue Chip Set component** groups multiple [chips](/components/chip/) into a single container that manages roving focus, keyboard navigation, and selection. While an individual chip handles its own state (selection, removal), the chip set is responsible for everything that spans the whole group:
...
<Example code={ChipSetExampleRaw} name="ChipSetExample">
...
<Example code={ChipSetSelectableExampleRaw} name="ChipSetSelectableExample">
...
<Example code={ChipSetSingleExampleRaw} name="ChipSetSingleExample">
...
<Example code={ChipSetFilterExampleRaw} name="ChipSetFilterExample">
...
<Example code={ChipSetRemovableExampleRaw} name="ChipSetRemovableExample">
