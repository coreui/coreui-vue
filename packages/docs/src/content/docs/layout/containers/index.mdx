...
import ContainersDefaultContainerExample from './examples/ContainersDefaultContainerExample.vue'
import ContainersDefaultContainerExampleRaw from './examples/ContainersDefaultContainerExample.vue?raw'
import ContainersResponsiveContainersExample from './examples/ContainersResponsiveContainersExample.vue'
import ContainersResponsiveContainersExampleRaw from './examples/ContainersResponsiveContainersExample.vue?raw'
import ContainersFluidContainersExample from './examples/ContainersFluidContainersExample.vue'
import ContainersFluidContainersExampleRaw from './examples/ContainersFluidContainersExample.vue?raw'
...
<Example code={ContainersDefaultContainerExampleRaw} lang="vue" name="ContainersDefaultContainerExample">
  <ContainersDefaultContainerExample client:only="vue" />
</Example>
...
<Example code={ContainersResponsiveContainersExampleRaw} lang="vue" name="ContainersResponsiveContainersExample">
  <ContainersResponsiveContainersExample client:only="vue" />
</Example>
...
<Example code={ContainersFluidContainersExampleRaw} lang="vue" name="ContainersFluidContainersExample">
  <ContainersFluidContainersExample client:only="vue" />
</Example>
