...
<Example code={FormSwitchExampleRaw} lang="vue" name="FormSwitchExample">
...
<Example code={FormSwitchSizingExampleRaw} lang="vue" name="FormSwitchSizingExample">
...
<Example code={FormSwitchReverseExampleRaw} lang="vue" name="FormSwitchReverseExample">
