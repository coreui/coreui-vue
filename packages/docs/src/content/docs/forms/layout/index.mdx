...
<Example code={LayoutFormGridExampleRaw} lang="vue" name="LayoutFormGridExample">
...
<Example code={LayoutGuttersExampleRaw} lang="vue" name="LayoutGuttersExample">
  <LayoutGuttersExample client:only="vue" />
</Example>

More complex layouts can also be created with the grid system.

<Example code={LayoutGutters2ExampleRaw} lang="vue" name="LayoutGutters2Example">
...
<Example code={LayoutHorizontalFormExampleRaw} lang="vue" name="LayoutHorizontalFormExample">
...
<Example code={LayoutHorizontalFormLabelSizingExampleRaw} lang="vue" name="LayoutHorizontalFormLabelSizingExample">
...
<Example code={LayoutColumnSizingExampleRaw} lang="vue" name="LayoutColumnSizingExample">
...
<Example code={LayoutAutoSizingExampleRaw} lang="vue" name="LayoutAutoSizingExample">
  <LayoutAutoSizingExample client:only="vue" />
</Example>

You can then remix that once again with size-specific column classes.

<Example code={LayoutAutoSizing2ExampleRaw} lang="vue" name="LayoutAutoSizing2Example">
...
<Example code={LayoutInlineFormsExampleRaw} lang="vue" name="LayoutInlineFormsExample">
