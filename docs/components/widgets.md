...
!!!include(./docs/api/widgets/CWidgetStatsA.api.md)!!!

!!!include(./docs/api/widgets/CWidgetStatsB.api.md)!!!

!!!include(./docs/api/widgets/CWidgetStatsC.api.md)!!!

!!!include(./docs/api/widgets/CWidgetStatsD.api.md)!!!

!!!include(./docs/api/widgets/CWidgetStatsE.api.md)!!!

!!!include(./docs/api/widgets/CWidgetStatsF.api.md)!!!